...
export function swapTwoCards(deck) {
  return [deck.values[0], deck.values[1]] = [deck.values[1], deck.values[0]], deck.values;
}
...
export function shiftThreeCardsAround(deck) {
  return [deck.values[0], deck.values[1], deck.values[2]] = [deck.values[1], deck.values[2], deck.values[0]], deck.values;
}
